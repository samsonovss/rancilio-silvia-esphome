...
`Silvia Start Backflush` запускает автоматическую программу промывки помпой и трёхходовым клапаном. `Silvia Stop Backflush` прерывает программу и выключает помпу с клапаном. `Silvia Reset Backflush Shots` вручную сбрасывает счётчик напоминания.
